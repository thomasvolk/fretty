...
test:
	...
	./fretty.py example/C-major-scale-box2.ft -o test-img-02.svg
	...
	./fretty.py example/Amaj7-chord.ft -o test-img-03.svg
	./fretty.py example/Cm-chord.ft -o test-img-04.svg
	./fretty.py example/D-chord.ft -o test-img-05.svg
